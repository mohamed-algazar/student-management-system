...
export function update(msg, model) {
    ...
    switch (msg.tag) {
        ...
        default: {
            ...
            return [new Model(newSystem, message, model.ShowAddDialog, model.ShowEditDialog, false, model.NewStudent, model.EditingStudent, model.SelectedView, model.PassingGrade), Cmd_none()];
        }
    }
}
...
function loginView(dispatch) {
    let value, elems_4, elems_3, elems, elems_1, value_21, value_26, value_34, elems_2;
    let username = "";
    let password = "";
    return createElement("div", createObj(ofArray([(value = "min-h-screen bg-gradient-to-br from-blue-500 via-indigo-600 to-purple-700 flex items-center justify-center", ["className", value]), (elems_4 = [createElement("div", createObj(ofArray([["className", "bg-white rounded-2xl shadow-2xl p-10 w-96"], (elems_3 = [createElement("div", createObj(ofArray([["className", "text-center mb-8"], (elems = [createElement("span", {
        ...
        dispatch(new Msg(0, [username, password]));
    }]])))], ["children", Interop_reactApi.Children.toArray(Array.from(elems_1))])]))), createElement("div", createObj(ofArray([["className", "mt-6 text-sm text-gray-600 text-center space-y-1"], (elems_2 = [createElement("p", {
